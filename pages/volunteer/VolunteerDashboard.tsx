              ...
              {editingMember && (
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 pb-8">
                      <Input label="Given Name" disabled={isEditingVerified} value={editingMember.name} onChange={(e) => setEditingMember({...editingMember, name: e.target.value})} icon={<User size={12} />} className="py-2.5 text-xs font-bold" />
                      <Input label="Surname" disabled={isEditingVerified} value={editingMember.surname} onChange={(e) => setEditingMember({...editingMember, surname: e.target.value})} icon={<User size={12} />} className="py-2.5 text-xs font-bold" />
                      <Input label="Father Name" disabled={isEditingVerified} value={editingMember.father_name} onChange={(e) => setEditingMember({...editingMember, father_name: e.target.value})} icon={<UserCircle size={12} />} className="py-2.5 text-xs font-bold" />
