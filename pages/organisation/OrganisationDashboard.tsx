    ...
    return (
        <DashboardLayout title="Entity Command Center">
            ...
            <div className="space-y-8">
                ...
                <div className="relative overflow-hidden p-8 lg:p-12 rounded-3xl border border-white/5 bg-gradient-to-br from-gray-900 to-black shadow-2xl">
                    {/* Atmospheric Glows */}
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-orange-500/5 blur-[130px] -mr-64 -mt-64 rounded-full pointer-events-none"></div>
                    <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-blue-500/5 blur-[100px] -ml-32 -mb-32 rounded-full pointer-events-none"></div>
                    
                    <div className="relative z-10 flex flex-col lg:flex-row gap-12 items-start lg:items-center">
                        {/* Organisation Master Identity */}
                        <div className="flex-1 flex gap-8 items-start">
                            <div className="p-7 bg-orange-600/10 rounded-2xl border border-orange-500/20 text-orange-500 shadow-2xl shadow-orange-950/20 group hover:rotate-3 transition-transform duration-500">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex flex-wrap gap-5">
                                    <div className="flex items-center gap-4 px-6 py-3 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-xl shadow-inner">
                                        <Phone size={20} className="text-orange-500" />
                                        <div className="flex flex-col">
                                            <span className="text-[9px] uppercase font-black text-gray-500 tracking-[0.2em]">Contact Node</span>
                                            <span className="text-base font-mono text-gray-200 tracking-wider">{orgDetails?.mobile || 'No Data'}</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-4 px-6 py-3 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-xl shadow-inner">
                                        <ShieldCheck size={20} className="text-green-500" />
                                        <div className="flex flex-col">
                                            <span className="text-[9px] uppercase font-black text-gray-500 tracking-[0.2em]">Security Tier</span>
                        ...
                        {/* Secretary / Principal Card */}
                        <div className="lg:w-[420px] p-10 bg-black/60 rounded-3xl border border-white/5 shadow-2xl backdrop-blur-3xl group hover:border-orange-500/30 transition-all duration-500">
                            ...
                            <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
                                <span className="text-[9px] font-black uppercase text-gray-600 tracking-[0.3em]">Operational Level</span>
                                <span className="text-[10px] font-black text-orange-500 bg-orange-500/10 px-4 py-1.5 rounded-full border border-orange-500/20">Secure Tier 2</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <Card className="group relative overflow-hidden p-10 border-white/5 hover:border-orange-500/30 transition-all duration-500 bg-gray-900/10">
                        <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-all duration-500 rotate-12 group-hover:rotate-0">
                            <Users size={160} />
                        </div>
                        <div className="flex items-center space-x-12">
                            ...
                            <div>
                                <p className="text-gray-500 text-[11px] font-black uppercase tracking-[0.3em] mb-3">Authorized Field Assets</p>
                                <div className="flex items-baseline gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-[10px] font-bold text-gray-600 uppercase tracking-widest">Agents</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <Card className="group relative overflow-hidden p-10 border-white/5 hover:border-blue-500/30 transition-all duration-500 bg-gray-900/10">
                        <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-all duration-500 -rotate-12 group-hover:rotate-0">
                            <UserCheck size={160} />
                        </div>
                        <div className="flex items-center space-x-12">
                            <div className="p-7 bg-blue-500/10 rounded-2xl text-blue-500 group-hover:bg-blue-500/20 transition-colors">
                                <UserCheck size={56} strokeWidth={1.5} />
                            </div>
                            <div>
                                ...
                                <div className="flex items-baseline gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-[10px] font-bold text-gray-600 uppercase tracking-widest">Records</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-12">
                            <div className="md:col-span-2 space-y-6">
                                <p className="text-gray-400 text-lg leading-relaxed">
                                    ...
                                    Your team of <b>{myVolunteers.length}</b> field agents has successfully verified and cataloged <b>{myMembers.length}</b> community members in this operational cycle.
                                </p>
